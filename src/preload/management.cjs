...
contextBridge.exposeInMainWorld('pluginApi', {
  ...
  inspectRepository: (repo) => ipcRenderer.invoke('marketplace:inspect-repository', repo),
  approveBuild: (packageName) => ipcRenderer.invoke('marketplace:approve-build', packageName),
  openRepository: (url) => ipcRenderer.send('marketplace:open-repository', url),
